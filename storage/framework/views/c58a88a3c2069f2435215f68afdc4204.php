...
<body class="bg-gray-600">
    ...
    <div class="flex items-center justify-center h-screen">
        <div
            ...
            <form method="post" action="<?php echo e(route('products.update', ['product' => $product])); ?>" class="max-w-sm mx-auto" enctype="multipart/form-data">
                <?php echo csrf_field(); ?>
                ...
                <div class="mb-5">
                    <label for="qty" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">
                        Qty</label>
                    <input type="text" id="qty" name="qty" value="<?php echo e($product->qty); ?>"
                        class="shadow-sm bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500 dark:shadow-sm-light"
                        required>
                </div>
                <div class="mb-5">
                ...
                <div class="mb-5">
                    <label for="description" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">
                        Description</label>
                    <input type="text" id="description" name="description" value="<?php echo e($product->description); ?>"
                        class="shadow-sm bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500 dark:shadow-sm-light"
                        required>
                </div>
                <div class="mb-5">
...
<?php /**PATH C:\xampp\htdocs\robles-app\resources\views/products/edit.blade.php ENDPATH**/ ?>